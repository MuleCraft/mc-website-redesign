        ...
        <div className="relative overflow-hidden rounded-3xl" style={{ backgroundColor: '#002144' }}>
          <div className="flex flex-col lg:flex-row lg:items-center px-6 py-8 lg:px-16 lg:py-10">
            <div className="lg:w-3/5 text-center lg:text-left">
              <h2 className="font-bold text-white text-2xl md:text-3xl lg:text-4xl leading-[1.2] mb-6">
                Fast-track integration and automation
              </h2>
              <p className="text-base text-white/90 max-w-[550px] mx-auto lg:mx-0 mb-8 leading-relaxed">
              ...
              <div className="mt-8">
                <a
                  href="#"
                  className="inline-block bg-white font-semibold text-base py-4 px-10 rounded-full transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-[0_8px_24px_rgba(255,255,255,0.3)]"
                  style={{ 
