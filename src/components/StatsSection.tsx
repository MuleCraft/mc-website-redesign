...
const StatCard = ({ stat }: { stat: Stat }) => (
  <div 
    className="text-center backdrop-blur-[16px] p-4 sm:p-5 md:p-6 transition-all duration-300 ease-out"
    style={{
      borderRadius: '2.4rem',
  ...
  >
    <p className="mb-2 sm:mb-3 text-2xl sm:text-3xl md:text-4xl font-bold leading-tight bg-gradient-to-r from-[#00A1FF] to-[#0066CC] bg-clip-text text-transparent">
       <AnimatedNumber valueString={stat.value} />
    </p>
    <p className="mx-auto max-w-[240px] text-xs sm:text-sm leading-5 text-white/70">
      {stat.description}
    </p>
  </div>
);
  ...
  return (
    <section className="bg-black py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 md:px-8">
        <h2 className="mb-6 sm:mb-8 md:mb-12 text-center text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-white px-2">
